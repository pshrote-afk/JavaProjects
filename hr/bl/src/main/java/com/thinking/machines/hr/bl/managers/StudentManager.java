...
public static StudentManagerInterface getStudentManager()
{
...
{
this.rollNoWiseStudentsMap = new TreeMap<>();
this.enrollmentNumberWiseStudentsMap = new TreeMap<>();
this.aadharCardNumberWiseStudentsMap = new TreeMap<>();
...
student.setCourseCode(dlStudent.getCourseCode());
...
student.setFees(dlStudent.getFees()); 		//doubt
student.setEnrollmentNumber(dlStudent.getEnrollmentNumber());
student.setAadharCardNumber(dlStudent.getAadharCardNumber());
//now add to DS
this.rollNoWiseStudentsMap.put(student.getRollNo(),student); //no need for toUpperCase(), since roll no is actually numbers stored as a String
this.enrollmentNumberWiseStudentsMap.put(student.getEnrollmentNumber(),student);
this.aadharCardNumberWiseStudentsMap.put(student.getAadharCardNumber(),student);
